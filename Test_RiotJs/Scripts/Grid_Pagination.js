...
{ 
	a =	{ 
			contenido: void 0 !== a.contenido ? a.contenido : "",
			 ...
			 return $.each(a.attr, function (a, n) { t += n }),
			 	 a.attr = t,
			 	   ...
			 	   { 
			 	   		...
			 	   		{ 
			 	   			contenido: void 0 !== a.contenido ? a.contenido : "",
			 	   					   ...
			 	   					   style: void 0 !== a.style ? a.style : "",
			 	   					   attr: void 0 !== a.attr ? a.attr : [],
			 	   					   href: void 0 !== a.href ? a.href : "_self", target: void 0 !== a.target ? a.target : "" 
			 	   		}; 
				 	   	var t = "";
			 	   ...
			 	   { 
			 	   		...
			 	   		{ 
			 	   			contenido: void 0 !== a.contenido ? a.contenido : "",
			 	   					  "class": void 0 !== a["class"] ? a["class"] : "",
			 	   					  style: void 0 !== a.style ? a.style : "",
			 	   					  attr: void 0 !== a.attr ? a.attr : [], id: void 0 !== a.id ? a.id : "", 
...
function Grid_select(a) 
			 	   { 
			 	   		...
			 	   		$.each(a.attr, function (a, n) 
			 	   			...
			 	   			a.attr = t; var n = $('<select style="' + a.style + '" class="form-control input-sm ' + a["class"] + '" ' + a.attr + "></select>");
...
$.fn.Grid = function (a) { "use strict"; function t() 
			 	   	 ...
			 	   	 { 
			 	   	 	...
			 	   	 	var a = P.tabla.find("." + x.filas); $(P.data).each(function (t, n) 
			 	   	 																{ 
			 	   	 																	var o = $('<tr data-fila="' + t + '" class="' + x.fila + t + '"></tr>'); 

			 	   	 																	$(P.modelo).each(function (a, t) 
			 	   	 																		{ 
			 	   	 																			var e = _(r(t.style, "")), l = $('<td class="' + r(t["class"], "") + '" style="' + e + '"></td>'), s = "";
			 	   	 																			void 0 !== t.propiedad && (s = t.propiedad.indexOf(".") > -1 ? i(n, t.propiedad) : n[t.propiedad]), void 0 !== t.formato ? l.html(t.formato(o, n, s)) : l.text(s), o.append(l) }), a.append(o) }), v(!1), m(!1), P.cargarPaginacion() 
			 	   	 } 
			 	   	 function o() 
			 	   	{ 
			 	   	 	...
			 	   	 	{
			 	   	 		 if (a.html(""), h())
			 	   	 		  P.contenedor.append('<select class="form-control input-lg ' + x.paginador_responsive + '"></select>'); 
			 	   	 		 else 
			 	   	 		 	{ 
			 	   	 ...
			 	   	 { 
			 	   	 	if (h()) 
			 	   	 	{ 
			 	   	 		var a = P.contenedor.find("." + x.paginador_responsive); a.html("");
			 	   	 		for (var t = 1; t <= P.paginas; t++) 
			 	   	 		{ 
			 	   	 			var n = $('<option value="' + t + '">' + t + " / " + P.paginas + "</option>"); 
			 	   	 			t === P.pagina && n.attr("selected", !0), a.append(n) 
			 	   	 		} 
			 	   	 	} 
			 	   	 } 
			 	   	 ...
			 	   	 function g() 
			 	   	 { 
			 	   	 	var a = ""; return $.each(P.limite, function (t, n) 
			 	   	 										{ 
			 	   	...
			 	   	{ 
			 	   	 	var t = ""; 
			 	   	 	if ("object" == typeof a) 
			 	   	 		for (var n in a) t += n + ":" + a[n] + ";"; else t = a; return t 
			 	   	} 
			 	   	...
			 	   	var y = { 
			 	   		...
			 	   		x = { 
			 	   				...
			 	   				filtro_control: b + "-filtro-control", filtro_limpiar: b + "-filtro-limpiar", 
			 	   		...
			 	   		P = { 
							 	   						...
							 	   						{ 
							 	   							...
							 	   							error: function (t, n, o) 
							 	   									{ 
							 	   										...
							 	   										m(!1), 
							 	   										v(!1), 
							 	   										a.html('<tr class="danger"><td colspan="' + P.columnas.length + '" class="danger text-center">' + y.error_cargando + "</td></tr>"), 
							 	   										console.log(o + " | " + n) 
							 	   									} 
							 	   						}) 
			 	   							}, 
			 	   			...
			 	   			P.tabla.on("change", "." + x.filtro_control, function (a) 
			 	   														 { 
			 	   														 	var t = $(this); 
			 	   														 	t.is("select") && (t.find("option:selected").index() > 0 ? s({ columna: t.data("columna"), valor: t.val() }) : c(t.data("columna")), P.pagina = 1, P.cargarData()) 
			 	   														 }), 
			 	   			P.tabla.on("click", "." + x.filtro_limpiar, function (a) 
			 	   														{ 
			 	   															var t = $(this).closest(".input-group").find("." + x.filtro_control); t.val(""), c(t.data("columna")), P.pagina = 1, P.cargarData() 
			 	   														}), 
			 	   																 ...
			 	   																 { 
			 	   																 	if (13 == a.keyCode) 
			 	   																 		{ 
			 	   																 			...
			 	   																 			if ($(this).val() == P.pagina) 
			 	   																 				return; if ($(this).val() > P.paginas) return; 
			 	   																 			if (0 === $(this).val()) 
			 	   																 				return; P.pagina = parseInt($(this).val()), P.cargarData() 
			 	   																 		} 
			 	   																 	}), 
			 	   			...
			 	   			P.tabla.on("click", "." + x.paginador_anterior, function () 
			 	   															{ 
			 	   																$(this).attr("disabled") || l(P.pagina) && 1 != $("." + x.paginador_pagina_actual).val() && (P.pagina -= 1, P.cargarData()) }), P.tabla.on("click", "." + x.paginador_final, function () 
			 	   																																																											 {
			 	   																...
			 	   																P.contenedor.on("change", "." + x.paginador_responsive, function () 
			 	   																														...
			 	   																														{ 
			 	   																														    ...
			 	   																														    parametros: function (a) { P.parametros = a },
			 	   																														    obtener: function (a) { return P.obtener(a) } 
			 	   																														} 
};